...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/wk_cms2/sam7k9621/CMSSW_9_2_8/src/TriggerEfficiency/DataFltr/test/test_electron.root')
)
...
process.filterpath = cms.Path(process.datafltr)
