...
config = config()
config.General.requestName = 'TnP_DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8'
...
config.Data.outLFNDirBase = '/store/user/pusheng/HLTSF_2019_Oct_22_1510'
