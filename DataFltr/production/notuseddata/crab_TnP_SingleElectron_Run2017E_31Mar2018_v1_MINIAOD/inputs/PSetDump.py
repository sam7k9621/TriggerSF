...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/wk_cms2/sam7k9621/CMSSW_9_4_6_patch1/src/TriggerEfficiency/DataFltr/test/test.root')
)
...
process.edmOut = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TnP_test_electron.root'),
...
process.filterpath = cms.Path(process.egmGsfElectronIDSequence+process.datafltr)
