...
config = config()
config.General.requestName = 'TnP_EGamma_Run2018D_UL2018_MiniAODv2_v2_MINIAOD'
config.General.workArea = './crab_config_18-UL_2021_Sep_13/'
...
config.Data.outLFNDirBase = '/store/user/pusheng/HLTSF_2021_Sep_13_1308'
