...
config = config()
config.General.requestName = 'TnP_SingleElectron_Run2016H_21Feb2020_UL2016_v2_MINIAOD'
...
config.Data.inputDataset  = '/SingleElectron/Run2016H-21Feb2020_UL2016-v2/MINIAOD'
