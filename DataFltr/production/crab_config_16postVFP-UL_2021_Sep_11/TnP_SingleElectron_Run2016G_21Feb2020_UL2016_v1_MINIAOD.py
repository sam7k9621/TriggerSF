...
config = config()
config.General.requestName = 'TnP_SingleElectron_Run2016G_21Feb2020_UL2016_v1_MINIAOD'
...
config.Data.inputDataset  = '/SingleElectron/Run2016G-21Feb2020_UL2016-v1/MINIAOD'
