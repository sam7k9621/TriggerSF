...
config = config()
config.General.requestName = 'TnP_SingleElectron_Run2016D_21Feb2020_UL2016_HIPM_v1_MINIAOD'
...
config.Data.inputDataset  = '/SingleElectron/Run2016D-21Feb2020_UL2016_HIPM-v1/MINIAOD'
