...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:/afs/cern.ch/work/p/pusheng/CMSSW_10_6_20/src/TriggerSF/DataFltr/test/test.root')
)
...
process.edmOut = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('TnP_el_16preVFP-UL.root'),
    outputCommands = cms.untracked.vstring(
        'keep *', 
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('106X_mcRun2_asymptotic_preVFP_v9'),
