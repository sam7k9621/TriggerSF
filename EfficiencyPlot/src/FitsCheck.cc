...
TrgPlotMgr<TH1>& FitsMgr(const string& subdir){
...
void DrawFitsFail(const string& trg){
...
void DrawFitsPass(const string& trg){
...
vector<TH1*> HIST(const string& name){
