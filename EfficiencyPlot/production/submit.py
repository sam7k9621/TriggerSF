...
pos      = "/wk_cms2/sam7k9621/CMSSW_9_4_0_patch1/src/TriggerEfficiency/EfficiencyPlot/data/"
crabfile = "/wk_cms2/sam7k9621/CMSSW_9_4_0_patch1/src/TriggerEfficiency/DataFltr/production/Tnp_2017_data_crab/"

datalst = [
        crabfile + 'crab_TnP_SingleElectron_Run2017B_17Nov2017_v1_MINIAOD/results/',
        crabfile + 'crab_TnP_SingleElectron_Run2017C_17Nov2017_v1_MINIAOD/results/',
        crabfile + 'crab_TnP_SingleElectron_Run2017D_17Nov2017_v1_MINIAOD/results/',
        crabfile + 'crab_TnP_SingleElectron_Run2017E_17Nov2017_v1_MINIAOD/results/',
        crabfile + 'crab_TnP_SingleElectron_Run2017F_17Nov2017_v1_MINIAOD/results/'
        ]
...
cd /wk_cms2/sam7k9621/CMSSW_9_4_0_patch1/src && eval `scramv1 runtime -sh`
cmsRun /wk_cms2/sam7k9621/CMSSW_9_4_0_patch1/src/TriggerEfficiency/EfficiencyPlot/production/EffPlot_cfg.py inputFiles_load={0} output={1} useMC={2}
"""
...
def main(args):
    ...
    for mc in mclst :
        ...
        outfile = opt.tag + '_' + outfile[2] + "_" + outfile[3] + "_"  + outfile[4]
